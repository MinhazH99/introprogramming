...
class volunteerCampFunctions:
    ...
    def pick_relevant_camps(emergency_plan_index):
        ...
        while choice not in l:
            ...
            choice = volunteerCampFunctions.pick_relevant_camps(emergency_plan_index)
        return choice
    ...
    def choose_camp():
        ...
        if len(a) > 0: #i.e., if there are any rows in the dataframe with this username
            ...
            if camp_id != 'NaN':
                ...
                choice = volunteerCampFunctions.pick_relevant_camps(emergency_plan)
            ...
            volunteerCampFunctions.choose_camp()
    ...
    def view_camp():
        ...
        if len(a) > 0: #i.e., if there are any rows in the dataframe with this username
            ...
            if camp_id != 'NaN':
                ...
                if action == 0:
                    volunteerCampFunctions.change_camp #call main menu function
                elif action == 1:
                    print("Goodbye")
                else: #error handling
                    pass
            ...
            print("Username not found!")
            volunteerCampFunctions.view_camp()
    ...
    def change_camp():
        ...
        if len(a) > 0: #i.e., if there are any rows in the dataframe with this username
            ...
            print("Username not found!")
            volunteerCampFunctions.change_camp()
...
volunteerCampFunctions.change_camp()
# volunteerCampFunctions.pick_relevant_camps(0)
